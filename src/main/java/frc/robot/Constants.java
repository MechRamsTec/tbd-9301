...
public class Constants {
  ...
  public static class kSwerve {
    ...
    public static final double TRACK_WIDTH = Units.inchesToMeters(20.15); // Width of the drivetrain measured from the middle of the wheels.
    public static final double WHEEL_BASE = Units.inchesToMeters(20.15); // Length of the drivetrain measured from the middle of the wheels.
    ...
    public static final double DRIVE_GEAR_RATIO = 8.14; // 6.75:1
    ...
    public static final double ANGLE_GEAR_RATIO = 150 / 7; // 12.8:1
    ...
    /** Swerve constraints. */
    public static final double MAX_VELOCITY_METERS_PER_SECOND = 3.8;
    public static final double MAX_ANGULAR_RADIANS_PER_SECOND = 4.0; //ver q onda
